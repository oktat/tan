...
* [https://github.com/oktat/human_17_crud.git](https://github.com/oktat/human_17_crud.git)
...
```html
{{ (isAdmin ? 'Hozzáférés ok' : 'Tiltott elérés) | uppercase }}
```
...
```cmd
ng generate pipe shared/pipe/salaryhuf
```

```cmd
ng g p shared/pipe/salaryhuf
```
